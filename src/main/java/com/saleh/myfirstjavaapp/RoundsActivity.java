...
public class RoundsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Up Button
        Button upBu =findViewById(R.id.rounds_home);
        ...
        Spinner spinner=findViewById(R.id.rounds_spinner);
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Position=position;
                ListView listView=findViewById(R.id.rounds_listView);
                adapter=new matchesAdapter(RoundsActivity.this,loadQuery((Position)+""));
    ...
    public ArrayList<match> loadQuery(String round){
        ArrayList<match> roundMatches;
        dbManager dbManager =new dbManager(this);
        String[] selectionArgs ={round};
        roundMatches = dbManager.loadMatches("RoundId Like ? ",selectionArgs,"MatchRoundId");
        return roundMatches;
    }
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (list!=null&&list1!=null) {
                    dbManager dbManager=new dbManager(RoundsActivity.this);
                    dbManager.deleteAll();
                    matches.clear();
                    ...
                    Toast.makeText(RoundsActivity.this,"Data Retrieved from FB in Rounds Activity",Toast.LENGTH_SHORT).show();
                    AddtoDB(matches);
                    ListView listView=findViewById(R.id.rounds_listView);
                    adapter=new matchesAdapter(RoundsActivity.this,loadQuery(Position+""));
                    listView.setAdapter(adapter);
